...
def test_partial_overlap_missing_line():
    ...
    ctx_ids = tok.encode(context_text, add_special_tokens=False)
...
def test_partial_overlap_with_extra_line_then_realign_on_newline():
    ...
    ctx_ids_part = tok.encode(context_text_part, add_special_tokens=False)
